  ...
  <Tab title="Trader endpoints">
    ...
    <AccordionGroup>
      ...
      <Accordion title="GET /api/v1/leaderboard">
        ...
        curl \
          -H "x-api-key: YOUR_API_KEY" \
          https://exchange.jamesxu.dev/api/v1/leaderboard
        ```
      </Accordion>
  ...
  <Tab title="Admin endpoints">
    ...
    <AccordionGroup>
      ...
      <Accordion title="GET /api/v1/admin/state">
        Returns the current exchange state including trading controls, configured markets, recent admin messages, and persistence status.
      ...
      <Accordion title="POST /api/v1/admin/markets">
        ...
        **Request body**
        ...
        <ParamField path="body.display_name" type="string" required>
        ...
        <ParamField path="body.enabled" type="boolean">
          Whether the market is open for trading on creation.
        </ParamField>
      ...
      <Accordion title="POST /api/v1/admin/markets/{market_id}/settle">
        ...
        **Request body**
        ...
        <ParamField path="body.settlement_price" type="number" required>
          The admin-determined true value per share. PnL is realized against each trader's signed net position at this price.
        </ParamField>
